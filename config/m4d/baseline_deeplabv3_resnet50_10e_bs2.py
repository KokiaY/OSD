...
from network.models.baselines import TorchvisionDeepLabV3
...
weights_name = "baseline_deeplabv3_resnet50_10e_bs2"
...
net = TorchvisionDeepLabV3(num_classes=num_classes, pretrained_backbone=True)
