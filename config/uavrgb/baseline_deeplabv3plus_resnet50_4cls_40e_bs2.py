...
from network.models.baselines import ResNetDeepLabV3Plus
...
weights_name = "baseline_deeplabv3plus_resnet50_4cls_40e_bs2"
...
net = ResNetDeepLabV3Plus(num_classes=num_classes, pretrained_backbone=True)
