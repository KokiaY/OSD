...
UAVRGB_CONFIG="${UAVRGB_CONFIG:-config/uavrgb/d2ls_swin_v4_k1.py}"
M4D_CONFIG="${M4D_CONFIG:-config/m4d/d2ls_swin_v4_k1.py}"
MADOS_CONFIG="${MADOS_CONFIG:-config/mados/d2ls_swin_weighted_v4_k1.py}"

LAUNCH_LOG="train_logs/uavrgb_m4d_mados_v4_k1_${RUN_ID}.jobs"
MASTER_LOG="train_logs/uavrgb_m4d_mados_v4_k1_${RUN_ID}.log"
touch "$LAUNCH_LOG"
